...
it('should render CurrentFilters', () => {
  const component = renderer.create(
      <ListCurrentFilters current_filters={{ projects: { "operator": "=", "value": 1 },
        trackers: { "operator": "=", "value": 2 },
        status: { "operator": "=", "value": 2 },
        watched: { "operator": "=", "value": "true" },
        assigned_to: { "operator": "=", "value": 1 },
        updated_at: { "operator": ">", "value": "12/12/2017" },
        text: "test" }}
